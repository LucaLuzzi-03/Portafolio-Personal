          ...
          <div className="proyectos__container-content_title">
            ...
            <div className="proyectos__container-content_proyectos" ref={scrollRef} >
              ...
              <div className="proyecto">
                <img src={ images.restaurante } alt="project image" />
              ...
              <div className="proyecto">
                <img src={ images.hoobank } alt="project image" />
              ...
              <div className="proyecto">
                <img src={ images.gpt3 } alt="project image" />
              ...
              <div className="proyecto">
                <img src={ images.gifApp } alt="project image" />
              ...
              <div className="proyecto">
                <img src={ images.reduxStore } alt="project image" />
